...
``
    return (
        <div className="w-full h-screen sm:h-auto relative">
            <div className="w-full h-screen    flex justify-center items-center   sm:w-full sm:mb-10 sm:h-auto lg:w-full lg:h-auto">
                <img src={Left} alt="" className="mt-[-360px]  w-[100px] sm:ml-[-40px] sm:hidden"/>
                <div className="w-[50%] h-screen sm:w-full sm:h-auto sm:mb-20  ">
                    <img src={Fon} alt="" className="pt-[50px] w-[620px]  pl-[100px] sm:pl-0 hidden sm:block sm:ml-5 lg:pl-0"
                         data-aos="fade-right" data-aos-duration="400"/>
                    <div className="pl-[80px] pt-[-550px] sm:pl-10 ">
                        <h1 className="text-[50px] pt-[220px] pl-[50px] sm:pt-40 sm:text-[40px] sm:w-[250px]  lg:pl-0   sm:pl-0 sm:pr-32]">
                            Baxt <span className="text-[#DB6300]">Sayohatdir</span>
                        </h1>
                        <h3 className="text-[25px] w-[580px] pl-[50px] pt-4 sm:pl-0 sm:w-[300px] lg:pl-0">
                            No matter where in the world you want to go, we can help get you there
                        </h3>
                        <p className="text-[16px] w-[560px] pt-10 text-[#666666] pl-[50px] sm:pl-0  sm:w-[300px] lg:pl-0">
                ...
                <div className="w-[50%] h-screen sm:w-full sm:h-auto lg:h-auto lg:w-full">
                        <img src={Fon} alt="" className="pt-[50px] w-[620px]  pl-[100px] sm:pl-0 sm:hidden lg:w-full lg:pl-0 lg:pt-20 " data-aos="fade-right" data-aos-duration="400"/>
                </div>
                <img src={Right} alt="" className="mt-[-450px]  w-[100px] sm:absolute sm:right-0 sm:hidden"/>
            </div>
            <div className="w-[950px] h-[120px] rounded-md border border-[#CACACA] mt-[-80px] ml-[200px]   sm:flex sm:flex-col sm:w-[90%] sm:ml-4 sm:h-auto lg:w-[98%] lg:ml-0 lg:mx-auto lg:flex lg:flex-col">
                <form onSubmit={handleSubmit} className="flex space-x-4 p-4 sm:flex-col lg:space-x-2">
