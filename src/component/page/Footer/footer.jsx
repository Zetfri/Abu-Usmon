                    ...
                    <div className={"w-full flex flex-col items-start justify-start mt-10 gap-6 "} data-aos="fade-down" data-aos-delay="200">
                        ...
                        <div className={"flex gap-6 justify-center items-center"} data-aos="fade-down"  data-aos-delay="400">
                            ...
                            <span className={"text-white flex flex-col justify-start items-start gap-1"}>
                                ...
                                <a href="Tel:+99891 322 07 87"
                                   className={"flex w-auto gap-2 justify-center items-center"}>
                                    <img src={Uzb} alt="" className={"w-[30px] h-[30px]"}/>
                                    📞+99891 322 07 87
                                </a>
                                <a href="Tel:+99897 386 07 87"
                                   className={"flex w-auto gap-2 justify-center items-center"}>
                                    <img src={Uzb} alt="" className={"w-[30px] h-[30px]"}/>
                                    📞+99897 386 07 87
                                </a>
                                <a href="Tel:+966 50 905 3786"
                                   className={"flex w-auto gap-2 justify-center items-center"}>
                                    <img src={Sau} alt="" className={"w-[30px] h-[30px]"}/>
                                    📞+966 50 905 3786

                                </a>
                                <a href="Tel:+966 56 291 1630"
                                   className={"flex w-auto gap-2 justify-center items-center"}>
                                    <img src={Sau} alt="" className={"w-[30px] h-[30px]"}/>
                                    📞+966562911630

                                </a>
                            <a href="https://t.me/Mukhsin_06" className="flex w-auto gap-2 justify-center items-center"
                               target="_blank" rel="noopener noreferrer">
    <img src={Sau} alt="Telegram Icon" className="w-[30px] h-[30px]"/>
    <span>Mukhsin</span>
</a>

                            </span>
                        </div>
                        <div className={"flex gap-6 justify-center items-center"} data-aos="fade-down"
                             data-aos-delay="500">
